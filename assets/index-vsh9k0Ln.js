...
68. **provided** /prəˈvaɪdɪd/
    conj. 如果，只要，在…条件下`,Er=`# 2027考研英语红宝书
## 必考词Unit10 77词
...
71. **writer** /ˈraɪtə(r)/
    n. 作家，作者；写的人
`,Br=`# 2027考研英语红宝书必考词Unit 7（80词）提取结果
...
`,Ur=/^\s*(\d+)\.\s+\*\*(.+?)\*\*\s+(\/.+\/)\s*$/,Wr=/^\s*([A-Za-z][A-Za-z'’.-]*(?:\s+[A-Za-z][A-Za-z'’.-]*)?)\s+(\/[^/]+\/)\s*$/,Gr=/^((?:[a-z]+\.)+(?:\s+[a-z]+\.)*)\s+(.+)$/i;function Kr(e,t){let n=e.match(/^#{1,3}\s+(.+)$/m)?.[1]?.trim(),r=n?.match(/(必考词)\s*Unit\s*(\d+)/i);return r?`${r[1]} Unit${r[2]}`:n?.replace(/\s*\d+\s*词\s*$/,``).trim()||t}function qr(e){let t=e.match(/^#{1,3}\s+.+?(\d+)\s*词/m)?.[1];return t?Number(t):void 0}function Jr(e){return e.map(e=>e.trim()).filter(Boolean).map(e=>{let t=e.match(Gr);return t?{pos:t[1].trim(),meaning:t[2].trim()}:{pos:``,meaning:e}})}function Yr(e,t){let n=t.unitName||Kr(e,t.unitId),r=e.split(/\r?\n/),i=[],a,o=()=>{if(!a)return;let e=i.length+1;i.push({id:`${t.unitId}-${String(e).padStart(3,`0`)}`,unitId:t.unitId,unitName:n,order:e,word:a.word,phonetic:a.phonetic,definitions:Jr(a.definitions)})};for(let e of r){let t=e.match(Ur);if(t){o(),a={order:Number(t[1]),word:t[2].trim(),phonetic:t[3].trim(),definitions:[]};continue}let n=e.match(Wr);if(n){o(),a={order:i.length+1,word:n[1].trim(),phonetic:n[2].trim(),definitions:[]};continue}a&&(!e.trim()||e.trim().startsWith(`#`)||a.definitions.push(e))}return o(),{id:t.unitId,name:n,order:t.order,expectedCount:qr(e),words:i,referenceImages:t.referenceImages}}var Xr=Object.assign({"../../单词文本/分区/19.md":_r,"../../单词文本/分区/20.md":vr,"../../单词文本/分区/21.md":yr,"../../单词文本/分区/22.md":br,"../../单词文本/分区/23.md":xr,"../../单词文本/分区/24.md":Sr,"../../单词文本/分区/25.md":Cr,"../../单词文本/分区/26.md":wr,"../../单词文本/分区/必修1.md":Tr,"../../单词文本/分区/必修10.md":Er,"../../单词文本/分区/必修11.md":Dr,"../../单词文本/分区/必修12.md":Or,"../../单词文本/分区/必修13.md":kr,"../../单词文本/分区/必修14.md":Ar,"../../单词文本/分区/必修15.md":jr,"../../单词文本/分区/必修16.md":Mr,"../../单词文本/分区/必修17.md":Nr,"../../单词文本/分区/必修18.md":Pr,"../../单词文本/分区/必修2.md":Fr,"../../单词文本/分区/必修3.md":Ir,"../../单词文本/分区/必修4.md":Lr,"../../单词文本/分区/必修5.md":Rr,"../../单词文本/分区/必修6 .md":zr,"../../单词文本/分区/必修7.md":Br,"../../单词文本/分区/必修8 .md":Vr,"../../单词文本/分区/必修9.md":Hr}),Zr={一:1,二:2,三:3,四:4,五:5,六:6,七:7,八:8,九:9,十:10};function Qr(e){return(e.split(`/`).pop()||e).replace(/\.[^.]+$/,``)}function $r(e){let t=e.match(/\d+/)?.[0];if(t)return Number(t);let n=e.match(/[一二三四五六七八九十]+/)?.[0];if(n){if(n===`十`)return 10;if(n.startsWith(`十`))return 10+(Zr[n[1]]||0);if(n.endsWith(`十`))return(Zr[n[0]]||1)*10;if(n.includes(`十`)){let[e,t]=n.split(`十`);return(Zr[e]||1)*10+(Zr[t]||0)}return Zr[n]}}function ei(e,t){let n=t?.match(/Unit\s*(\d+)/i)?.[1];return n?Number(n):$r(Qr(e))||999}var ti=Object.entries(Xr).map(([e,t])=>{let n=ei(e,t);return Yr(t,{unitId:`unit${n}`,unitName:`必备词 Unit${n}`,order:n})}).sort((e,t)=>e.order-t.order);ti.find(e=>e.id===`unit1`)||ti[0],ti.find(e=>e.id===`unit2`);var ni=ti.flatMap(e=>e.words);function ri(e){let t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`reword-progress-${new Date().toISOString().slice(0,10)}.json`,r.click(),URL.revokeObjectURL(n)}function ii(e,t,n=6e4){return e.lastReviewedAt?t.getTime()-new Date(e.lastReviewedAt).getTime()<n:!1}function ai(e,t){return t.rewardHistory[0]&&t.rewardHistory[0]?.id!==e.rewardHistory[0]?.id}function oi(){let[e,t]=(0,y.useState)({name:`dashboard`}),[n,r]=(0,y.useState)(()=>gt()),[i,a]=(0,y.useState)(()=>Ct()),[o,s]=(0,y.useState)(),c=(0,y.useMemo)(()=>ti.find(t=>t.id===e.unitId)||ti[0],[e.unitId]),l=e.unitId?c.words:ni;(0,y.useEffect)(()=>{(e.name===`study`||e.name===`recall`||e.name===`quiz`)&&window.scrollTo({top:0})},[e.name,e.unitId]),(0,y.useEffect)(()=>{if(!o)return;let e=window.setTimeout(()=>s(void 0),2600);return()=>window.clearTimeout(e)},[o]);let u=(e,t,r=n)=>{let i=Ht(t,ni,r);return wt(i),ai(e,i)&&s(i.rewardHistory[0]),i},d=(e,t=n)=>{a(n=>u(n,e(n),t))},f=(e,t,n)=>{r(r=>{let i=r[e]||pt(e),o=t(i),s={...r,[e]:o};return _t(s),n&&a(e=>u(e,n(e,i,o,s),s)),s})},p=e=>{f(e,e=>Ot(e),(e,t)=>t.learned?e:k({...e,totalWordsLearned:e.totalWordsLearned+1},{type:`study`,title:`新词入库`,description:`完成 1 个新单词初学`,xp:2,coins:1,monsterPoints:1}))},m=(e,t)=>{let n=new Date;f(e,e=>t===`known`?kt(e,n):t===`fuzzy`?At(e,n):jt(e,n),(r,i,a)=>{if(ii(i,n))return r;let o={...r,totalWordsReviewed:r.totalWordsReviewed+1};return t===`known`?o=k(o,{type:`review`,title:`复习命中`,description:`理解模式记住 1 个单词`,xp:4,coins:2,monsterPoints:3}):t===`fuzzy`&&(o=k(o,{type:`review`,title:`复习推进`,description:`标记 1 个不熟词，进入加固周期`,xp:1,monsterPoints:1})),t===`known`&&j(a)&&!o.defeatedWordIds.includes(e)&&(o=k({...o,defeatedWordIds:[...o.defeatedWordIds,e],defeatedMonsters:o.defeatedMonsters+1},{type:`monster`,title:`击败单词小怪`,description:`一个单词进入掌握状态`,xp:10,coins:5,monsterPoints:10})),o})},h=(e,t)=>{let n=new Date;f(e,e=>t?mt(kt({...e,correctCount:e.correctCount+1},n),`quiz-correct`,n):mt(jt({...e,wrongCount:e.wrongCount+1},n),`quiz-wrong`,n),(r,i,a)=>{let o=ii(i,n),s={...r,totalQuizCount:r.totalQuizCount+1,totalCorrectCount:r.totalCorrectCount+ +!!t,totalWrongCount:r.totalWrongCount+ +!t};return!o&&t&&(s=k(s,{type:`quiz`,title:`测试答对`,description:`测验中答对 1 题`,xp:3,coins:1,monsterPoints:2})),t&&j(a)&&!s.defeatedWordIds.includes(e)&&(s=k({...s,defeatedWordIds:[...s.defeatedWordIds,e],defeatedMonsters:s.defeatedMonsters+1},{type:`monster`,title:`击败单词小怪`,description:`测试命中让单词进入掌握状态`,xp:10,coins:5,monsterPoints:10})),s})},g=e=>{try{r(bt(e)),a(Ct())}catch(e){window.alert(e instanceof Error?e.message:`导入失败`)}},_=()=>{window.confirm(`确定清空所有学习进度、金币和打卡记录吗？`)&&(vt(),r({}),a(Ct()))},v=(0,y.useCallback)(e=>{a(t=>{let n=un(t).todaySeconds,r=ln(t,e);if(r===t)return t;let i=un(r).todaySeconds;[{minutes:15,xp:20,coins:8,monsterPoints:8},{minutes:30,xp:35,coins:12,monsterPoints:12},{minutes:60,xp:80,coins:25,monsterPoints:25}].forEach(e=>{n<e.minutes*60&&i>=e.minutes*60&&(r=k(r,{type:`study`,title:`专注 ${e.minutes} 分钟`,description:`今日学习时长达标`,xp:e.xp,coins:e.coins,monsterPoints:e.monsterPoints}))});let a=Ht(r,ni,gt());return wt(a),ai(t,a)&&s(a.rewardHistory[0]),a})},[]),b=()=>{d(e=>qt(e))},x=()=>{if(!Kt(ni,n,i)){window.alert(`今日任务还没达成，先学几个新词、复习或完成一次测试。`);return}d(e=>Jt(e))},S=e=>{a(t=>{let n=ir(t,e);return n===t?(window.alert(`金币/钻石不足，或已经拥有这个物品。`),t):u(t,n)})},C=e=>{let t=ti.find(t=>t.id===e);t&&d(r=>{let i=bn(t,n,r);return!i.eligible||i.defeated?(window.alert(`Boss 还不能挑战：需要本单元学习达到 80%，并且没有到期复习。`),r):k({...r,defeatedBossIds:[...r.defeatedBossIds,e],defeatedMonsters:r.defeatedMonsters+1},{type:`monster`,title:`击败 ${i.name}`,description:`完成一个单元 Boss 挑战`,xp:100,coins:50,diamonds:1,monsterPoints:60,bypassDailyCap:!0})})},w=e=>{d(t=>({...t,audioSettings:e}))},ee=e=>t({name:e}),te=e.name===`study`||e.name===`quiz`||e.name===`total`?e.name:e.name===`recall`?e.dueOnly?`review`:`recall`:void 0;return(0,D.jsxs)(Xe,{current:e.name,onNavigate:ee,children:[o?(0,D.jsx)(`div`,{className:`fixed left-1/2 top-20 z-50 w-[min(92vw,360px)] -translate-x-1/2`,children:(0,D.jsx)(Ze,{reward:o})}):null,e.name===`dashboard`?(0,D.jsx)(_n,{units:ti,words:ni,progressMap:n,stats:i,onSignIn:b,onNavigateReview:()=>t({name:`review`}),onNavigateUnits:()=>t({name:`units`}),onNavigateCheckIn:()=>t({name:`checkin`}),onNavigateMonster:()=>t({name:`monster`}),onNavigateShop:()=>t({name:`shop`}),onNavigateStatistics:()=>t({name:`statistics`})}):e.name===`units`?(0,D.jsx)(mr,{units:ti,progressMap:n,onOpenUnit:e=>t({name:`unitDetail`,unitId:e})}):e.name===`unitDetail`?(0,D.jsx)(fr,{unit:c,progressMap:n,onStudy:()=>t({name:`study`,unitId:c.id}),onRecall:()=>t({name:`recall`,unitId:c.id}),onQuiz:()=>t({name:`quiz`,unitId:c.id})}):e.name===`study`?(0,D.jsx)(ur,{unit:e.unitId?c:void 0,words:l,progressMap:n,audioSettings:i.audioSettings,onLearn:p}):e.name===`recall`?(0,D.jsx)(Qn,{title:e.unitId?`${c.name} 理解功能`:`总理解功能`,words:l,progressMap:n,audioSettings:i.audioSettings,initialDueOnly:e.dueOnly,onGrade:m,onBackToStudy:()=>t({name:`study`,unitId:e.unitId})}):e.name===`quiz`?(0,D.jsx)(Jn,{title:e.unitId?`${c.name} 测试功能`:`总测试功能`,words:l,allWords:ni,progressMap:n,audioSettings:i.audioSettings,onAnswer:h}):e.name===`total`?(0,D.jsx)(dr,{words:ni,progressMap:n,audioSettings:i.audioSettings,onStudy:()=>t({name:`study`}),onRecall:()=>t({name:`recall`}),onQuiz:()=>t({name:`quiz`})}):e.name===`review`?(0,D.jsx)($n,{words:ni,progressMap:n,audioSettings:i.audioSettings,onStartReview:()=>t({name:`recall`,dueOnly:!0}),onOpenUnits:()=>t({name:`units`})}):e.name===`checkin`?(0,D.jsx)(Zt,{words:ni,progressMap:n,stats:i,onSignIn:b,onCheckIn:x}):e.name===`rewards`?(0,D.jsx)(er,{stats:i}):e.name===`shop`?(0,D.jsx)(or,{stats:i,onExchange:S}):e.name===`monster`?(0,D.jsx)(wn,{words:ni,units:ti,progressMap:n,stats:i,onChallengeBoss:C}):e.name===`statistics`?(0,D.jsx)(cr,{stats:i,words:ni,progressMap:n}):e.name===`achievements`?(0,D.jsx)(Ut,{stats:i,words:ni,progressMap:n}):e.name===`settings`?(0,D.jsx)(tr,{stats:i,onUpdateAudio:w}):(0,D.jsx)(Tn,{words:ni,progressMap:n,stats:i,onNavigateCheckIn:()=>t({name:`checkin`}),onNavigateRewards:()=>t({name:`rewards`}),onNavigateShop:()=>t({name:`shop`}),onNavigateStatistics:()=>t({name:`statistics`}),onNavigateAchievements:()=>t({name:`achievements`}),onNavigateSettings:()=>t({name:`settings`}),onExport:()=>ri(yt()),onImport:g,onReset:_}),(0,D.jsx)(gr,{mode:te,unitId:e.unitId,wordCount:l.length,onComplete:v})]})}Le.createRoot(document.getElementById(`root`)).render((0,D.jsx)(y.StrictMode,{children:(0,D.jsx)(oi,{})})),`serviceWorker`in navigator&&window.addEventListener(`load`,()=>{let e=!1;navigator.serviceWorker.addEventListener(`controllerchange`,()=>{e||(e=!0,window.location.reload())}),navigator.serviceWorker.register(`/reword/sw.js`).then(e=>{e.update(),e.waiting&&e.waiting.postMessage({type:`SKIP_WAITING`}),e.addEventListener(`updatefound`,()=>{let t=e.installing;t?.addEventListener(`statechange`,()=>{t.state===`installed`&&navigator.serviceWorker.controller&&t.postMessage({type:`SKIP_WAITING`})})})}).catch(()=>void 0)});